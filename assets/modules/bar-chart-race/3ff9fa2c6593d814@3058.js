...
async function* _chart(replay,d3,width,height,bars,axis,labels,ticker,keyframes,duration,x,invalidation)
{
  ...
  const svg = d3.select("#Pmodules2").append("svg")
...
export default function race(runtime, observer) {
  ...
  const fileAttachments = new Map([
	...
	["category-brands.csv", {url: new URL("./files/processed_data_race", import.meta.url), mimeType: "text/csv", toString}]	
  ]);
